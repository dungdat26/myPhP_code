...
handleSearchfunction = () => {
  // console.log(this.state.search);
      ...
      handleValidaInput = (array_key_check,run_item) =>{
        ...
        console.log(this.state[array_key_check[run_item]].length);
    ...
    handleSubmit= (e) =>{
      ...
      if(this.state.id == 'dungdat' && this.state.mk == 'Impossible26'){
          ...
          <LogoBanner title_logo={this.state.title_logo} />
            <div className="top-menu">
              ...
              <ul className="nav1">
                ...
                :
                <li><a className="btn btn-danger" data-toggle="modal" href='#modal-id'>Login</a></li>
                }
              </ul>
            </div>
