...
if(isset($_POST["chuoi_so"])){
    ...
    //$mang=implode(',',$mang);
    $demxh=array_count_values($mang);
    $unique=array_unique($mang);
...
<div class="col-xs-3 col-sm-3 col-md-3 col-lg-3">
   <label>Số lần xuất hiện:</label>  
    ...
    <input type="text" name=" " id="input" class="form-control" value="<?php  print_r($demxh) ?>" >
    </div>
</div>
<div class="col-xs-3 col-sm-3 col-md-3 col-lg-3">
   <label>Mảng duy nhất:</label>  
    </div>

    <div class="col-xs-9 col-sm-9 col-md-9 col-lg-9">
    
    <input type="text" name="" id="input" class="form-control" value="<?php  echo $unique  ?>">
    </div>
</div>
<div class="form-group">
