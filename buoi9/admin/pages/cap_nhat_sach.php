...
<div class="title_page">
    ...
    <form action="" method="POST" class="form-horizontal" role="form">
        ...
        <div class="form-group">
            ...
            <div class="col-sm-10">
                <input type="text" name="ten_sach" id="input" class="form-control" value="<?php  
                if(isset($_POST['ten_sach'])) 
                        echo $_POST['ten_sach']; 
                    else if($thong_tin_sach_cap_nhat) 
                        echo $thong_tin_sach_cap_nhat->ten_sach; ?>" title="">
            </div>
        </div> 
        ...
        <div class="form-group">
            ...
            <div class="col-sm-10">
                <input type="text" name="sku" id="input" class="form-control" value="<?php  
                if(isset($_POST['sku'])) 
                        echo $_POST['sku']; 
                    else if($thong_tin_sach_cap_nhat) 
                        echo trim($thong_tin_sach_cap_nhat->sku); ?>"  title="">
            </div>
        </div> 
                    ...
                    foreach($ds_loai_sach as $item_loai_sach){
                        ...
                        if(count($item_loai_sach->ds_con)){
                            foreach($item_loai_sach->ds_con as $item_loai_con){
                                ?>
                                <option value="<?php echo $item_loai_con->id; ?>" <?php if($item_loai_sach->id == $thong_tin_sach_cap_nhat->id_loai_sach) echo 'selected ="selected"' ;?> >
        ...
        <div class="form-group">
            ...
            <div class="col-sm-10">
                ...
                <input type="text" name="doc_thu" id="input" class="form-control" value="<?php 
        ...
        <div class="form-group">
            ...
            <div class="col-sm-10">
                <input type="text" name="so_trang" id="input" class="form-control" value="<?php 
        ...
        <div class="form-group">
            ...
            <div class="col-sm-10">
                <input type="text" name="ngay_xuat_ban" id="input" class="form-control" value="<?php 
        ...
        <div class="form-group">
            ...
            <div class="col-sm-10">
                <input type="text" name="kich_thuoc" id="input" class="form-control" value="<?php 
        ...
        <div class="form-group">
            ...
            <div class="col-sm-10">
                <input type="text" name="trong_luong" id="input" class="form-control" value="<?php 
                if(isset($_POST['trong_luong'])) 
                    echo $_POST['trong_luong'];
                else if($thong_tin_sach_cap_nhat)
                    echo trim($thong_tin_sach_cap_nhat->trong_luong);
                ?>"  title="">
            </div>
        </div> 
        ...
        <div class="form-group">
            ...
            <div class="col-sm-10">
                <input type="number" name="don_gia" id="input" class="form-control" value="<?php 
                if(isset($_POST['don_gia'])) 
                    echo $_POST['don_gia']; 
                 else if($thong_tin_sach_cap_nhat)
                    echo trim($thong_tin_sach_cap_nhat->don_gia);
                    ?>"  title="">
            </div>
        </div>
        ...
        <div class="form-group">
            ...
            <div class="col-sm-10">
                <input type="text" name="gia_bia" id="input" class="form-control" value="<?php 
                if(isset($_POST['gia_bia'])) 
                    echo $_POST['gia_bia'];
                else if($thong_tin_sach_cap_nhat)
                    echo trim($thong_tin_sach_cap_nhat->gia_bia);
                ?>"  title="">
            </div>
        </div>  
