...
if($_SERVER['REQUEST_METHOD'] == "GET"){
    ...
    $info_sach->id_loai_sach, $info_sach->id_nha_xuat_ban, $info_sach->so_trang, $info_sach->ngay_xuat_ban, $info_sach->kich_thuoc, 
    $info_sach->sku, $info_sach->trong_luong, $info_sach->trang_thai, $info_sach->hinh, $info_sach->don_gia, $info_sach->gia_bia, 
    $info_sach->noi_bat);
