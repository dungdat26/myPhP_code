...
if(isset($_POST['ho_ten_nguoi_nhan']) && isset($_SESSION['gio_hang'])){
    ...
    if($id_vua_them){
        ...
        $phpmail->Port = 465;
        $phpmail->IsHTML(true);
        $phpmail->Username = 'dungdat2602@gmail.com';
        $phpmail->Password = 'Impossible26';
        $phpmail->SetFrom("dungdat97@gmail.com");
        $phpmail->From = "dungdat07@gmail.com";
        ...
        else
        {
            ...
            <script>
                ...
                window.location.href = '/myPhP_code/buoi9/';
            </script>
            <?php
        }
