    ...
    <div class="container-fluid">
        ...
        <div class="col-xs-4 col-sm-4 col-md-4 col-lg-4">
            <div class="image_sach">
                <img src="./images/sach/<?php echo $thong_tin_sach->hinh; ?>" alt="">
            </div>
        </div>
        ...
        <div class="col-xs-8 col-sm-8 col-md-8 col-lg-8">
            ...
            <div class="include_xu_ly_gio_hang">
                <form action="/myPhP_code/buoi9/?page=gio_hang" method="POST" role="form">
                 <input type="number" name="so_luong" id="input" class="form-control" value="" required="required" title="">

                    <input type="hiden" name="id_sach" id="input"  value="<?php echo $thong_tin_sach->id ?>"  >
