...
const Contact = () => {
        ...
        return (
            <section id="contact">
        <div id="google-map" className="wow fadeIn" data-latitude="52.365629" data-longitude="4.871331" data-wow-duration="1000ms" data-wow-delay="400ms" />
                ...
                <div className="col-sm-6">
                  <div className="contact-info wow fadeInUp" data-wow-duration="1000ms" data-wow-delay="300ms">
                    ...
                    <ul className="address">
                      <li><i className="fa fa-map-marker" /> <span> Address:</span> 2400 South Avenue A </li>
                      <li><i className="fa fa-phone" /> <span> Phone:</span> +928 336 2000</li>
                      <li><i className="fa fa-envelope" /> <span> Email:</span><a href="mailto:someone@yoursite.com"> support@oxygen.com</a></li>
                      <li><i className="fa fa-globe" /> <span> Website:</span> <a href="#">www.sitename.com</a></li>
                    </ul>
                  </div>                            
                </div>
              </div>
