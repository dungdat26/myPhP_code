...
SELECT ten_sach, sku, gioi_thieu, kich_thuoc, trong_luong, don_gia, gia_bia 
FROM bs_sach
WHERE (id_loai_sach LIKE '%17'AND id_nha_xuat_ban LIKE'%11')
...
SELECT * 
FROM bs_sach
WHERE ((id_loai_sach LIKE '%56' OR id_loai_sach LIKE'%90'OR id_loai_sach LIKE'%92') AND trong_luong >= 300  )
ORDER BY trong_luong ASC;

/*1.14 */
SELECT * 
FROM bs_sach
WHERE (id_loai_sach LIKE '%45' OR don_gia <= 60000   );
